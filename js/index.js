...
$(document).ready(function () {
  ...
  // setting vistas
  // visualizacion de contenidos segun seleccion menu navegacion
  // depositos
  $('#depositoNav').click(function () {
    ...
    // oculpa
    $("#historial-cuenta").prop("hidden", true);
    $("#transferirBtn").prop("hidden", true);
    $("#destinatarioDiv").prop("hidden", true);
    $("#nuevoDestinatarioBtn").prop("hidden", true);

    /*
    $("#historial-cuenta").hide();    
    $("#operaciones-cuenta").show();
    */
  });
  // transferencias
  $('#transferirNav').click(function () {
    // si hay saldo disponible para transferencias
    if(balance > 0){
  ...
  function creaRegistro(fecha, tipo, monto, balance, destinatario) {
    //$("#registros").append('<tr><td>'+fecha+'</td><td>'+tipo+'</td><td>'+monto+'</td><td>'+balance+'</td><td>'+destinatario+'</td></tr>');
